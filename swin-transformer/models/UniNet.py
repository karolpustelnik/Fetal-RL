...
class VisionTransformer(nn.Module):
    def __init__(self, repeats, expansion, channels, strides=[1, 2, 2, 2, 1, 2], num_classes=1, drop_path_rate=0.,
        ...
        self.stem = nn.Sequential(
            nn.Conv2d(1, stem_dim, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False),
