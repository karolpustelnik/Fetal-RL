...
def train_test_split(data, train_size = 1000, precision = 0.005):
    ...
    train_set.to_csv('./outputs/fetal_extracted_map_train_scr_cls.csv', index = False) # saving the train set
    test_set.to_csv('./outputs/fetal_extracted_map_val_scr_cls.csv', index = False) # saving the test set
...
train_set, test_set = train_test_split('./outputs/labels_corrected.csv')
